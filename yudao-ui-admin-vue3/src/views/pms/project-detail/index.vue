        ...
        <el-row :gutter="16">
          ...
          <el-col :span="12">
            <el-form-item label="所属阶段" prop="stageId">
              <el-select filterable v-model="taskForm.stageId" placeholder="请选择阶段" class="w-full">
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="任务类型" prop="taskType">
              <el-select filterable v-model="taskForm.taskType" placeholder="请选择" class="w-full">
...
onMounted(async () => {
  ...
  loadProjectData()
  // 钉钉通知跳转：自动打开指定任务抽屉（查看详情场景）
  const notifyTaskId = route.query.taskId as string | undefined
  if (notifyTaskId && !route.query.action) {
    await nextTick()
