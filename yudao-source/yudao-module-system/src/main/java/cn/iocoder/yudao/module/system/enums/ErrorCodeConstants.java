...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_DINGTALK_LOGIN_FAILED = new ErrorCode(1_002_000_006, "钉钉免登失败，原因是：{}");
    ErrorCode AUTH_DINGTALK_NOT_CONFIGURED = new ErrorCode(1_002_000_009, "钉钉登录未配置，请联系管理员");
